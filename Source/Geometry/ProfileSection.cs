...
namespace ProceduralParts.Geometry
{
    public class ProfileSection
    {
        ...
        {
            _Points = points;
            //_Points = points.OrderBy(p=> GetPointAngle(p)).ToArray();
        ...
        //private static float GetPointAngle(ProfilePoint pp)
        //{
        //    var normPos = pp.Position.normalized;
        //    return Mathf.Atan2(normPos.x, normPos.y);
        //}
